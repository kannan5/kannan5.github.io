...
>
  <h1 class="font-medium">
    <b class="font-bold poppins">Kannan</b> M
  </h1>
  <div class="sm:flex ml-auto pr-4 item-center gap-4 hidden">
    ...
    <a
      href="#footer"
      class="blueShadow relative overflow-hidden px-5 ру-2 group rounded-full bg-white
     text-slate-950"
    >
      <div
